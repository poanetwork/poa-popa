                ...
                <div className="col-md-12">
                    <div className="row">
                        ...
                        <div className="col-md-6 sm-center pd-sm-3">
                            <span className="bottom-copy">2018 POA. All rights reserved.</span>
                        </div>
                        ...
                        <div className="col-md-6 sm-center pd-sm-3 text-right">
                            <a className="footer-social" href="https://twitter.com/poanetwork" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16">
                                    <path fill="#5C34A2" fill-rule="evenodd"
                            ...
                            <a className="footer-social" href="https://medium.com/poa" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16">
                                    <path fill="#5C34A2" fill-rule="evenodd"
