...
module.exports = function (opts) {
    ...
    router.post('/notifyRegTx', function (req, res) {
        ...
        if (verr) {
            logger.log(prelog + 'validation error on tx_id: ' + tx_id + ', err: ' + verr);
        ...
        if (verr) {
            logger.log(prelog + 'validation error on session_key: ' + session_key + ', err: ' + verr);
        ...
        db.get(session_key, function (err, info) {
            if (err) {
                logger.error(prelog + 'error getting info by session_key: ' + session_key + ', err: ' + err);
